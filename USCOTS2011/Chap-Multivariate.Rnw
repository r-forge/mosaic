...
\begin{center}
<<swim-data-raw,fig=true,pdf=true,include=true,echo=false>>=
swim.plot( )
@ 
\end{center}

\begin{center}
<<swim-data-raw2,fig=true,pdf=true,include=true,echo=false>>=
swim.plot2( )
@ 
\end{center}
...
<<swim-data-1,fig=true,pdf=true,include=true,echo=false>>=
...
<<swim-data-2,fig=true,pdf=true,include=true,echo=false>>=
...
<<swim-data-3,fig=true,pdf=true,include=true,echo=false>>=
...
<<swim-data-4,fig=true,pdf=true,include=true,echo=false>>=
swim.mod.plot(time ~ sex * year, dots=TRUE)
@ 
...
<<swim-data-5,fig=true,pdf=true,include=true,echo=false>>=
...
<<swim-data-6,fig=true,pdf=true,include=true,echo=false>>=
swim.mod.plot(time ~ poly(year,2), dots=TRUE)
@ 

<<swim-data-7,fig=true,pdf=true,include=true,echo=false>>=
swim.mod.plot(time ~ sex + poly(year,2), dots=TRUE)
@ 

<<swim-data-8,fig=true,pdf=true,include=true,echo=false>>=
swim.mod.plot(time ~ sex * poly(year,2), dots=TRUE)
@ 

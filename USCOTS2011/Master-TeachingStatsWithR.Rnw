...
\tikzNote{#1}{#2}{double copy shadow={opacity=.5},tape,fill=green!10,draw=green,thick}
}

\newcommand{\Caution}[2][Caution!]{%
\tikzNote{#1}{#2}{double copy shadow={opacity=.5},tape,fill=red!10,draw=red,thick}
}

...
\newcommand{\VN}[1]{{\color{blue!70}\texttt{#1}}}
\newcommand{\vn}[1]{{\color{blue!70}\texttt{#1}}}
\newcommand{\variable}[1]{{\color{blue!70}\texttt{#1}}}
\newcommand{\DFN}[1]{{\color{blue!70}\texttt{#1}}}
\newcommand{\dfn}[1]{{\color{blue!70}\texttt{#1}}}
\newcommand{\dataframe}[1]{{\color{blue!70}\texttt{#1}}}
\newcommand{\function}[1]{{\color{blue!70}\texttt{\StrSubstitute{#1}{()}{}()}}}
\newcommand{\option}[1]{{\color{blue!70}\texttt{#1}}}
\newcommand{\pkg}[1]{{\color{blue!70}\texttt{#1}}}

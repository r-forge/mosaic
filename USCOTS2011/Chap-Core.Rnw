...
\vspace{-4mm}
\begin{center}
<<cesd-hist,fig=TRUE,width=6,height=1.9>>=
histogram(~ cesd, HELP)
@
\end{center}
...
\begin{center}
<<cesd-dot3,fig=TRUE,width=6,height=1.9>>=
...
\begin{center}
<<dens1,fig=TRUE,width=6,height=1.9>>=
...
\begin{center}
<<norm1,fig=TRUE,width=6,height=1.9>>=
xpnorm(1.96, 0, 1)
@
\end{center}
...
\begin{center}
<<xyplot,fig=TRUE,width=6,height=3.9>>=
...
\begin{center}
<<lmhist,fig=TRUE,width=6,height=1.9>>=
histogram(~ residuals(model))
@
\end{center}

\begin{center}
<<lmplot,fig=TRUE,width=6,height=3.9>>=
plot(model)
@
\end{center}
...
\begin{center}
<<mosaicplot,fig=TRUE,width=6,height=3.9>>=
...
%\vspace{-8mm}
\begin{center}
<<cesd-box,fig=TRUE,width=6,height=1.9>>=

...
\FoodForThought{Not all package authors are equally skilled at creating examples.  Some of the examples
...
The \verb!findData()! function in \verb!abd! makes it easy to map examples and exercises in that book to 

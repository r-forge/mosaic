...
\InstructorNote{This isn't something you will typically have students do, but it
can help you make interesting fake data sets for examples, simulations, test questions, 
etc.}
...
@
the \verb!aggregate()! function stores its results in a data frame that lends itself

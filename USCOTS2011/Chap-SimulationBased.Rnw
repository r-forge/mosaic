...
sn1 <- do(500) * lm( width ~ shuffle(sex), data=KidsFeet ) 
...
Now, to construct Planet Alt: \InstructorNote{The instructor would
...
We'll discuss how to use such simulations in Section \ref{sec:power},
about power.

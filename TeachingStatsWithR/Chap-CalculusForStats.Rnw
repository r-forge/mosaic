...
<<decay-plot,fig.show=hold,include=TRUE,height=3>>=
curve( decay, 0, 20)
@ 
...
<<decay-plot-deriv,fig.show=hold,include=TRUE,height=3>>=
ddecay(4)
curve( ddecay, 0, 20)
@ 
...
<<decay-plot-integrate,fig.show=hold,include=TRUE,height=3>>=
f = antiD(decay)
curve(f, 0, 20)
@ 
...
<<norm-cumulative,fig.show=hold,include=TRUE,height=3>>=
